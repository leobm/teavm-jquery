...
import de.iterable.teavm.utils.jso.JSArrayUtils;
...
public final class JQuery {
    ...
    public static native JQueryXHR ajax(String url, JQueryAjaxSettingsObject settings);

    @JSBody(params = { "settings" }, script = "return jQuery.ajax(settings)")
    public static native JQueryXHR ajax(JQueryAjaxSettingsObject settings);
    ...
    public static native JQueryXHR post(JQueryAjaxSettingsObject settings);

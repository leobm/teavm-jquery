...
public abstract class JQueryObject<J extends JQueryObject<J>> implements JSObject, JSArrayReader<Element> {
	...
	@JSBody(params = { "content" }, script = "return this.append.apply(this, content)")
	public final native J append(String... content);

	@JSBody(params = { "content" }, script = "return this.append.apply(this, content)")
	public final native J append(JSString... content);

	@JSBody(params = { "content" }, script = "return this.v.apply(this, content)")
	...
	@SafeVarargs
	@JSBody(params = { "content" }, script = "return this.append.apply(this, content)")
	public final native J append(JQueryObject<?>... content);
	...
	public abstract J appendTo(JQueryObject<?> target);
